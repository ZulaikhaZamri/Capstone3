...
#2. Data loading
file_path = r"/content/drive/MyDrive/Capstone3_data"

BATCH_SIZE = 32
IMG_SIZE = (224,224)

data = keras.utils.image_dataset_from_directory(r"/content/drive/MyDrive/Capstone3_data", batch_size=BATCH_SIZE,image_size=IMG_SIZE,shuffle=True)
